...
Gatsby’s [File System Route API](https://www.gatsbyjs.com/docs/reference/routing/file-system-route-api/ "Link a la documentación de Gatsby" "_blank") defines a special syntax for naming the files in your src/pages directory, which lets you dynamically create new pages for your site based on a collection of nodes in the data layer.
